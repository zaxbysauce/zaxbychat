...
export type TStartupConfig = {
  ...
  mcpServers?: Record<
    string,
    {
      ...
      iconPath?: string;
      /**
       * First-class source-provider marker. Mirrored from `MCPOptions.kind`;
       * the frontend filters servers by this field to surface the GitHub
       * context picker only when a `kind: 'github'` server is configured.
       */
      kind?: 'github';
    }
  >;
